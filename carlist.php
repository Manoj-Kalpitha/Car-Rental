  ...
  <body >
    ...
    <nav class="navbar navbar-expand-lg navclr p-3">
        <div class="container-fluid">
          <a class="navbar-brand navclra" href="#"><img src="./Assest/img/logo_v4.png" class=" navimg rounded float-start" alt="..."></a>
...
<div class="work text-center ">
    <div class="container">
      <div class="main_heading text-center">
        <h2>Enyoj your<span>joiunery</span> </h2>
      ...
      <div class="row py-4">
        <div class="col-md-4"> 
          <div class="work1 rounded-2 ">
            ...
            <h4>car name</h4>
            <h5>Price</h5>
            <a href="car.html"><button class="button">book here</button></a>
          </div>
        </div>
    </div>
      <!-- ********************************************** -->
